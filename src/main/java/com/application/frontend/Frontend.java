...
public class Frontend {
    ...
    public static void menu() throws IOException {
        ...
        int op = sc.nextInt();
        switch (op) {
            case 1: type = libraryServices.login();
                break;
            case 2: libraryServices.registerNewMember();
                break;
        }
        if(op==1)
            if(type.equalsIgnoreCase("librarian")) {
                ...
                switch (option) {
                    case 1: libraryServices.searchByName();
                        break;
                    case 2: libraryServices.searchByAuthor();
                        break;
                    case 3: libraryServices.searchByGenre();
                        break;
                    case 4: libraryServices.issueBook();
                        break;
                    case 5: libraryServices.returnBook();
                        break;
